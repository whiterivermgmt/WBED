...
const photoRestorationItems = [
  { title: "Old Photo Repair", icon: <FaMagic size={20} /> },
  { title: "Color Correction", icon: <FaImage size={20} /> },
  { title: "Scratch & Tear Removal", icon: <FaFileImage size={20} /> },
  { title: "Background Restoration", icon: <FaLayerGroup size={20} /> },
  { title: "Retouching & Cleaning", icon: <FaPenFancy size={20} /> },
  { title: "Enhancement & Sharpening", icon: <FaVectorSquare size={20} /> },
  { title: "Black & White Conversion", icon: <FaFileAlt size={20} /> },
  { title: "Digital Archiving", icon: <FaUndoAlt size={20} /> },
  { title: "Artistic Restoration", icon: <FaShapes size={20} /> },
  { title: "Highlight & Enhance Features", icon: <FaHighlighter size={20} /> },
];
...
const Page = () => {
  const renderSection = (
    ...
    text: string,
    img: string,
    items: typeof photoRestorationItems,
    reverse = false
  ) => (
    ...
    <div className="space-y-16 lg:space-y-24">
      ...
      <section className="relative w-full py-10 bg-white flex flex-col items-center">
        <Container className="text-center">
          ...
          >
            Restore and preserve your treasured photographs with our professional photo restoration services. Bring your memories back to life.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      {renderSection(
        ...
        "Our photo restoration services repair damage, enhance colors, and preserve memories for generations to come.",
        "/services/repair.jpg",
        photoRestorationItems
      )}
    </div>
  );
};
