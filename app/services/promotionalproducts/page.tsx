...
const promoItems = [
  { title: "Custom T-Shirts", icon: <FaTshirt size={20} /> },
  { title: "Branded Mugs", icon: <FaMugHot size={20} /> },
  { title: "Pens & Stationery", icon: <FaPenFancy size={20} /> },
  { title: "Business Cards", icon: <FaClipboard size={20} /> },
  { title: "Bags & Packaging", icon: <FaShoppingBag size={20} /> },
  { title: "Custom Boxes", icon: <FaBoxOpen size={20} /> },
  { title: "Promotional Stickers", icon: <FaLayerGroup size={20} /> },
  { title: "Event Giveaways", icon: <FaGift size={20} /> },
  { title: "Awards & Recognition", icon: <FaStar size={20} /> },
  { title: "Certificates & Invitations", icon: <FaCertificate size={20} /> },
];
    ...
    <div className="space-y-16 lg:space-y-24">
      ...
      <section className="relative w-full py-10 bg-white flex flex-col items-center">
        <Container className="text-center">
          ...
          >
            Promote your brand with high-quality custom products. Perfect for events, marketing, and giveaways.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      {renderSection(
        ...
        "We create personalized products to help your business stand out and leave a lasting impression.",
        "/services/offset.jpg",
        promoItems
      )}
    </div>
